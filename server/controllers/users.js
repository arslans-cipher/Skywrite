...
export const getUserFriends = async (request, response) => {
  try {
    ...
    const formattedFriends = friends.map(({ _id, firstName, lastName, race, occupation, location, picturePath }) => {
        return { _id, firstName, lastName, race, occupation, location, picturePath }
      })
